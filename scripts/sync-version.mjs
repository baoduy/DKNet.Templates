#!/usr/bin/env node
// Copies package.json's version into .claude-plugin/plugin.json and plugin.json. Runs automatically as the
...
for (const file of ['.claude-plugin/plugin.json', 'plugin.json']) {
