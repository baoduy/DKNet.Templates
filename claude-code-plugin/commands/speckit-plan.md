---
description: Execute implementation planning workflow to generate design artifacts (research, data model, contracts)
argument-hint: "Optional planning focus. Example: focus on data model and API contracts"
---
