---
description: Create implementation-ready .NET architecture documentation for the current feature
argument-hint: "Optional feature name. Example: OrderManagement"
---
...
4. Create `architecture-review.md` with pass/fail checks.
5. If critical gaps remain, ask up to 5 targeted clarification questions.
6. Otherwise finalize both files and report readiness.
