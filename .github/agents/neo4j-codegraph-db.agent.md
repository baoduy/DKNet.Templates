...
## Core Skill
- Use the **neo4j-codegraph-qa** skill for all architectural Q&A tasks
...
- ONLY leverage the neo4j-codegraph-qa skill for graph queries
...
2. Invoke neo4j-codegraph-qa skill with the normalized query
