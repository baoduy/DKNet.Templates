...
/// <summary>
/// Captures log lines written through <see cref="ILogger"/> during a test run, so a test can assert on
/// observable log output instead of on internal call order. Registered as an additional <see cref="ILoggerProvider"/>
/// in the test host — it does not replace the console/other providers already configured.
/// </summary>
