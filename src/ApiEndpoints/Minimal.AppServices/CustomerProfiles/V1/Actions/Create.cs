...
///     <see cref="CustomerProfile" /> entity, and persisting it. The
///     <see cref="Minimal.Domains.Features.Profiles.Entities.CustomerProfileCreatedEvent" /> is raised by the DKNet events
///     hook via <c>[RaisesEvent]</c> on the entity after <c>SaveChanges</c>.
/// </summary>
    ...
    : Fluents.Requests.IHandler<CreateProfileRequest, CustomerProfileDto>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // CustomerProfileCreatedEvent is declared via [RaisesEvent] on the CustomerProfile entity and raised
        // automatically by the DKNet events hook after SaveChanges — no AddEvent call here.
