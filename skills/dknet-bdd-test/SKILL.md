...
Usage: `/dknet-bdd-test <Feature> e.g. Orders`
...
1. Load and follow the BDD skill at the `dknet-bdd-tests` skill.
2. Use the `dknet-bdd-tests` skill's `checklist.md` as the completion gate.
