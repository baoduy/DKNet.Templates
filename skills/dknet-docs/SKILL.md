...
1. the `dknet-feature-documentation` skill
2. the `dknet-feature-documentation` skill's `templates/` folder (README, architecture, data-model, events, api-reference templates).
